    ...
    public GestionarUsuarios() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int i = 0; i < 5; i++) {
                    fila[i] = rs.getObject(i + 1); //PORQUE EL PRIMER INDICE DE RS ES 0
                }

                //AGREGA LA FILA DENTRO DE MODEL.
                model.addRow(fila);
            }
            cn.close();
        ...
        //EVENTO PARA QUE SE ABRA UNA VENTANA CUANDO EL USUARIO HACE CLICK.
