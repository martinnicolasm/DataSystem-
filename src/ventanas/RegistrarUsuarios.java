...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    public RegistrarUsuarios() {
        ...
        setTitle("Registro de usuarios - Sesión de " + user);
        setSize(630,350);
        setResizable(false);
        setLocationRelativeTo(null);
        
        //PARA EVITAR QUE EL PROGRAMA TERMINE AL CERRAR ESTA VENTANA
    ...
    private void initComponents() {
        ...
        txt_nombre5.setBackground(new java.awt.Color(153, 153, 255));
        ...
        jLabel_Footer.setText("Creado por Martín Martinez ©");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        permisos_cmb = cmb_niveles.getSelectedIndex() + 1; //sumo uno ya que arranque de 0
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (validacion == 0) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "¡¡ERROR AL REGISTRAR USUARIO!! CONTACTE AL ADMIN");
                    }
                } else {
            ...
            JOptionPane.showMessageDialog(null, "¡¡ERROR al comparar usuario!!, CONTACTE AL ADMIN.");
        }
