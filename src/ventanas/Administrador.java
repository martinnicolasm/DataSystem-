...
public class Administrador extends javax.swing.JFrame {
    ...
    public static int sesion_usuario; //para enviar datos entre interfaces
    ...
    public Administrador() {
        initComponents();
        //Recuperar el nombre de usuario que viene desde LOGIN
        user = Login.user;
        sesion_usuario = 1;
        ...
        //PARA QUE AL CERRARSE LA INTERFAZ EL PROGRAMA DEJE DE FUNCIONAR EN SU TOTALIDAD
        ...
        jLabel_Wallpaper.setIcon(icono); //para las medidas de la imagen
        this.repaint();
    ...
    private void initComponents() {
        ...
        jButton_AcerdaDe = new javax.swing.JButton();
        ...
        getContentPane().add(jButton_Capturista, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 70, 120, 100));

        jButton_Tecnico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/tecnico.png"))); // NOI18N
        getContentPane().add(jButton_Tecnico, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 120, 100));

        jButton_AcerdaDe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/creatividad.png"))); // NOI18N
        getContentPane().add(jButton_AcerdaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 240, 120, 100));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 350, -1, -1));

        jLabel6.setText("Creado por Martín Martínez ©");
    ...
    private javax.swing.JButton jButton_AcerdaDe;
